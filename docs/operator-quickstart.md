# Operator Quickstart — cloud-itonami-isic-952

Shortest path from clone to a verified local dry-run for **ISIC 952** (`cloud-itonami-isic-952`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-952.git
cd cloud-itonami-isic-952
```
