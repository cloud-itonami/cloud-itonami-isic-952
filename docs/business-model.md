# Business Model: Repair of Personal and Household Goods - Administrative Coordination
...
- ISIC Rev.5: `` — Repair of Personal and Household Goods - Administrative Coordination
- Domain: `:services/repair-shop-coordination`
- Social impact: :operational-efficiency :administrative-transparency
- Actor: `:repairshop-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :services/repair-shop-coordination — who wants
...
One managed tenant (:services/repair-shop-coordination):
...
- Do not bypass the `:repairshop-governor` for production decisions.
